...
class CascadingBubbleOnDeviceTest {
    ...
    fun cascadingBubbleShapesDoNotSwallowTheNeighbour() = runBlocking {
        ...
        val blocks = OcrEngine(context, BubbleMaskSegmenter(context), BubbleBoxDetector(context), MangaOcrPipeline(context, BubbleBoxDetector(context))).recognize(bitmap, "English")
