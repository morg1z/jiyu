...
class CascadeOnLightBackgroundTest {
    ...
    fun probeShapesAndClassificationOnLightBackground() = runBlocking<Unit> {
        ...
        val raw = OcrEngine(context, BubbleMaskSegmenter(context), BubbleBoxDetector(context), MangaOcrPipeline(context, BubbleBoxDetector(context))).recognize(bitmap, "English")
